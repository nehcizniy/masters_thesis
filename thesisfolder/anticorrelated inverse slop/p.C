...
filename_array[file_index]=filename;
        ...
        while(inputfile.getline(line, sizeof(line)))
        {
            ...
            else
            {
                ...
                yield_steeper[CurrentCentIndex][CurrentPtIndex] = yield[CurrentCentIndex][CurrentPtIndex] + sysp[CurrentCentIndex][CurrentPtIndex] * (2*pt[CurrentCentIndex][CurrentPtIndex]/(int_low-int_high) + (int_high + int_low)/(int_high - int_low));
                yield_flat[CurrentCentIndex][CurrentPtIndex] = yield[CurrentCentIndex][CurrentPtIndex] + sysp[CurrentCentIndex][CurrentPtIndex] * (2*pt[CurrentCentIndex][CurrentPtIndex]/(int_high-int_low) + (int_high + int_low)/(int_low - int_high));
