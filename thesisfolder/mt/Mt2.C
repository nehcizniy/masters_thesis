...
leg->AddEntry(p2[32][0], "#pi", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[9][0], "k", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[35][0], "p", "p");
leg->AddEntry((TObject*)0, " ", "");

leg->AddEntry(new TNamed(), "3He+Au","");
leg->AddEntry(p2[31][0], "#pi", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[8][0], "k", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[34][0], "p", "p");
leg->AddEntry((TObject*)0, " ", "");
...
leg->AddEntry(p2[33][0], "#pi", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[10][0], "k", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry((TObject*)0, " ", "");
...
ratio_mass_parameters2->SetMaximum(0.9);
ratio_mass_parameters2->GetXaxis()->SetLimits(1.,1100.);
//for(int i=0;i<file_index;i++)
//{
 //   ratio_mass_parameters1->Add(p1[i]);
//}
...
TCanvas* c5 = new TCanvas("c5","parameter1 vs #frac{dN_{ch}}{d#eta}",800,800);
c5->SetLogx();
gPad->SetFixedAspectRatio();
//auto ratio_mass_parameters1 = new TGraphErrors(file_index, particle_mass3, parameter1, 0, error_parameter1);
...
ratio_mass_parameters3->GetXaxis()->SetLimits(1.,1100.);
//for(int i=0;i<file_index;i++)
//{
 //   ratio_mass_parameters1->Add(p1[i]);
//}
