...
filename_array[file_index]=filename;
    ...
    cout << pt[i][0] << yield[i][0] <<endl;
        g[k][i] = new TGraphMultiErrors(bin_num[i],mt[i],yield[i],width_error_bar[i],width_error_bar[i],statp[i], statp[i]);
    ...
    //    fit_int_yield_index->SetParLimits(1,0.5,2.5);
        ...
        error_parameter0[k][i] = fit_int_yield_index->GetParError(0);
        error_parameter1[k][i] = fit_int_yield_index->GetParError(1);
        ...
        cout << filename << "   " << Nch[i] << "    " << parameter0[k][i] << endl;
        delete fit_int_yield_index;
        ...
        g[k][i]->SetMarkerStyle(21+color_index); 
        g[k][i]->SetMarkerColorAlpha(20+color_index,1);//color[color_index]
        g[k][i]->SetLineColor(20+color_index); 
...
leg->AddEntry(p2[27][0], " ", "p");
leg->AddEntry(p2[22][0], " ", "p");
leg->AddEntry(p2[5][0], " ", "p");
leg->AddEntry(p2[1][0], " ", "p");
leg->AddEntry(p2[12][0], " ", "p");
leg->AddEntry(p2[16][0], " ", "p");

leg->AddEntry(new TNamed(), "Au+Au 2004","");
leg->AddEntry(p2[26][0], " ", "p");
leg->AddEntry(p2[21][0], " ", "p");
leg->AddEntry(p2[4][0], " ", "p");
leg->AddEntry(p2[0][0], " ", "p");
leg->AddEntry(p2[11][0], " ", "p");
leg->AddEntry(p2[15][0], " ", "p");

leg->AddEntry(new TNamed(), "Cu+Au","");
leg->AddEntry(p2[32][0], "#pi++#pi-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[9][0], "k++k-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[35][0], "p+#bar{p}", "p");
leg->AddEntry((TObject*)0, " ", "");

leg->AddEntry(new TNamed(), "3He+Au","");
leg->AddEntry(p2[31][0], "#pi++#pi-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[8][0], "k++k-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[34][0], "p+#bar{p}", "p");
leg->AddEntry((TObject*)0, " ", "");

// Add entries for dAu
leg->AddEntry(new TNamed(), "d+Au","");
leg->AddEntry(p2[28][0], " ", "p");
leg->AddEntry(p2[23][0], " ", "p");
leg->AddEntry(p2[6][0], " ", "p");
leg->AddEntry(p2[2][0], " ", "p");
leg->AddEntry(p2[13][0], " ", "p");
leg->AddEntry(p2[17][0], " ", "p");

leg->AddEntry(new TNamed(), "p+Au","");
leg->AddEntry(p2[29][0], " ", "p");
leg->AddEntry(p2[24][0], " ", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[19][0], " ", "p");

leg->AddEntry(new TNamed(), "p+Al","");
leg->AddEntry(p2[33][0], "#pi++#pi-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[10][0], "k++k-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(p2[18][0], " ", "p");

// Add entries for pp
leg->AddEntry(new TNamed(), "p+p","");
leg->AddEntry(p2[30][0], " ", "p");
leg->AddEntry(p2[25][0], " ", "p");
leg->AddEntry(p2[7][0], " ", "p");
leg->AddEntry(p2[3][0], " ", "p");
leg->AddEntry(p2[14][0], " ", "p");
leg->AddEntry(p2[20][0], " ", "p");
...
ratio_mass_parameters0->SetMaximum(0.7);
...
ratio_mass_parameters2->GetXaxis()->SetTitle("dN_{ch}/d#eta");
        ...
        ratio_mass_parameters2->SetMinimum(0.1);
        ratio_mass_parameters2->SetMaximum(0.6);
...
c4->Draw();
TString outputfilename = TString::Format("all-%f-%f.pdf", int_low, int_high);
