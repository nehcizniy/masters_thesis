...
filename_array[file_index]=filename;
    ...
    */}
    ...
    {   //stat_integrated_yield[i] = sqrt(stat_integrated_yield[i]);
        ...
        if(filename.Contains("phenix")){g[k] = new TGraphMultiErrors(NumCentIndex,Nch,integrated_yield_corrected,width_error_bar,width_error_bar,sys_integrated_yield, sys_integrated_yield);}
        //if(filename.Contains("star")){g[k] = new TGraphMultiErrors(NumCentIndex,Nch,integrated_yield,0,0,sys_integrated_yield, sys_integrated_yield);}
        ...
        // g[k]->GetAttLine(1)->SetLineColor(kBlue);
    ...
    //             p0[k]->SetPoint(0,parameter_index_mass[i],parameter0[k]);
    //             cout<< filename_array[k]<<endl;
    //             p1[k]->SetPoint(0,parameter_index_mass[i],parameter1[k]);
    //             p0[k]->SetPointError(0,0,error_parameter0[k]);
    //             p1[k]->SetPointError(0,0,error_parameter1[k]);
    //             p0[k]->SetMarkerColor(color[i]);
    //             p1[k]->SetMarkerColor(color[i]);
    //             g[k]->SetMarkerColor(color[i]);
    //         }
    //     }
    //     for(int i=0;i<2;++i)
    //     {
    //         if(filename.Contains(parameter_index_collab[i]))
    //         {
    //             p0[k]->SetMarkerSize(0.4*(1+i));
    //             p1[k]->SetMarkerSize(0.4*(1+i));
    //             g[k]->SetMarkerSize(0.4*(1+i));
    //         }
    //     }
    //     for(int i=0;i<8;++i)
    //     {
    //         if(filename.Contains(parameter_index_system[i]))
    //         {
    //             p0[k]->SetMarkerStyle(20+i);
    //             p1[k]->SetMarkerStyle(20+i);
    //             g[k]->SetMarkerStyle(20+i);
    //         }
    //     }
        ...
        //mg->GetYaxis()->SetLabelSize(.06);
//         plot.SetxTitleOffset(1.2);
//   plot.SetyTitleOffset(1.5);
//   plot.SetLabelSize(.06);
//   plot.SetLegendSize(0.05);
        gPad->SetTickx(1);
        gPad->SetTicky(1); 
        gPad->SetFixedAspectRatio();
...
leg->AddEntry(g[32], "#pi", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[9], "k", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[35], "p", "p");
leg->AddEntry((TObject*)0, " ", "");

leg->AddEntry(new TNamed(), "3He+Au","");
leg->AddEntry(g[31], "#pi", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[8], "k", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[34], "p", "p");
leg->AddEntry((TObject*)0, " ", "");
...
leg->AddEntry(g[33], "#pi", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[10], "k", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[18], " ", "p");
...
//auto ratio_mass_parameters0 = new TGraphErrors(file_index, particle_mass2, parameter0, 0, error_parameter0);
...
ratio_mass_parameters0->SetMinimum(0.5);
ratio_mass_parameters0->SetMaximum(1.5);
...
gPad->Modified();
c2->Draw();
TCanvas* c3 = new TCanvas("c3","mass vs parameter1",800,800);
//auto ratio_mass_parameters1 = new TGraphErrors(file_index, particle_mass2, parameter1, 0, error_parameter1);
...
ratio_mass_parameters1->SetMaximum(0.03);
