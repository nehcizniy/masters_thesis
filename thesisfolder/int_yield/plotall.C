...
leg->AddEntry(g[32], "#pi++#pi-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[9], "k++k-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[35], "p+#bar{p}", "p");
leg->AddEntry((TObject*)0, " ", "");

leg->AddEntry(new TNamed(), "3He+Au","");
leg->AddEntry(g[31], "#pi++#pi-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[8], "k++k-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[34], "p+#bar{p}", "p");
leg->AddEntry((TObject*)0, " ", "");
...
leg->AddEntry(g[33], "#pi++#pi-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[10], "k++k-", "p");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry((TObject*)0, " ", "");
leg->AddEntry(g[18], " ", "p");
