...
filename_array[file_index]=filename;
        ...
        while(inputfile.getline(line, sizeof(line)))
        {
            ...
            else
            {
                ...
                yield[CurrentCentIndex][CurrentPtIndex]=42.*yield[CurrentCentIndex][CurrentPtIndex];
                statp[CurrentCentIndex][CurrentPtIndex]=42.*statp[CurrentCentIndex][CurrentPtIndex];
                sysp[CurrentCentIndex][CurrentPtIndex]=42.*sysp[CurrentCentIndex][CurrentPtIndex];
                for(int i=0;i<8;++i)
        {
    ...
    int k = file_index;
        ...
        for (int i = 0; i < 1; ++i) //get ratio_binshift and yield_corrected
    {   
        int k = file_index;
        ...
        //     m_0 = parameter_index_mass[n];
        // }
        // }
    //     TF1* fTsallis = new TF1("fTsallis","[0]*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-1.)*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-2.)*pow(([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+sqrt(x*x+0.13970*0.13970))/([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+0.13970),-[2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5)))/(2.*3.1415*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+0.13970*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-1.))*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+0.13970))", xbin_fill[0], xbin_fill[M-1]);
    // fTsallis->SetParameters(42., 0.1, 10.);
    //     for(int j=0;j<10;++j)
    //     {
    //         spectra_fit[k][i]->Fit(fTsallis,"R");
    //     }
        //fTsallis->Draw();
...
//     }
    ...
    //std_pt[k][i] = TMath::Sqrt(sumDeviationSquared[i] / sumWeights[i]);
        ...
        spectra_fit[k][i]->SetMinimum(0.00000000001);
        spectra_fit[k][i]->SetMaximum(100.);
        spectra_fit[k][i]->GetAttLine(0)->SetLineColorAlpha(kRed, 1);
        //g[k][i]->GetAttLine(1)->SetLineColor(kBlue);
        //g[k]->GetAttFill(1)->SetFillStyle(0);
        spectra_fit[k][i]->SetMarkerStyle(20); 
        spectra_fit[k][i]->SetMarkerSize(1.); 
        spectra_fit[k][i]->SetMarkerColorAlpha(color[color_index],1);//color[color_index]
        //g[k][i]->SetLineColor(color[color_index]); 
        spectra_fit[k][i]->SetLineWidth(1); 
        spectra_fit[k][i]->SetFillStyle(0);
        ...
        mg->Add(spectra_fit[k][i], "AP ; Z ; 5 s = 0.5");
...
TF1* power_law = new TF1("power_law","[0]*pow(x/[1],-[2])",8.,20);
power_law->SetParameters(43.5, 0.112, 9.57);
for(int j=0;j<10;++j)
         {
             mg->Fit(power_law,"R");
         }

double pow_n = power_law->GetParameter(2);
cout<< pow_n<<endl;
TF1* fTsallis = new TF1("fTsallis","[0]*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-1.)*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-2.)*pow(([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+sqrt(x*x+[3]]*[3]]))/([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+[3]]),-[2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5)))/(2.*3.1415*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+[3]]*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-1.))*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+[3]]))", 0., 20.);
    fTsallis->SetParameters(43.5, 0.1127, 9.57,0.1);
    // fTsallis->FixParameter(10, 43.5);
    // fTsallis->FixParameter(1, 0.1127);
     fTsallis->FixParameter(2, pow_n);
     fTsallis->FixParameter(3, 0.139570);
         for(int j=0;j<10;++j)
         {
             mg->Fit(fTsallis,"R");
         }
        
TF1* fTsallis_integral_function = new TF1("fTsallis_integral_function","[0]*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-1.)*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-2.)*pow(([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+sqrt(x*x+[3]]*[3]]))/([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+[3]]),-[2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5)))/(2.*3.1415*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+[3]]*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))-1.))*([2]/49.*((1.+pow(49.+[3]]*[3]],0.5))*pow(49.+[3]]*[3]],0.5))*[1]+[3]]))", 0., 20.);

TGraphMultiErrors* xx[3];
for(int n=0;n<1;++n)
{   xx[n]= new TGraphMultiErrors(*spectra_fit[n][8]);
    for(int m=0;m<spectra_fit[n][8]->GetN();++m)
    {   
        double x,y = 0;
        spectra_fit[n][8]->GetPoint(m,x,y);
        double ratio = fTsallis->Eval(x)/y;
        xx[n]->SetPoint(m,x,ratio);
        
    }
}
TMultiGraph* ratio_plot = new TMultiGraph();
ratio_plot->Add(xx[0],"AP");
//ratio_plot->Add(xx[1],"AP");
//ratio_plot->Add(xx[2],"AP");
TCanvas* c1 = new TCanvas("c1","Pt vs Yield",800,600);
    c1->SetLogy();
    c1->SetLogx(0);
    gStyle->SetOptStat(0);
    gStyle->SetLegendBorderSize(0);
        mg->Draw("AP");
        power_law->Draw("same");
   mg->GetXaxis()->SetLimits(0.1,20.);
   //mg->GetYaxis()->SetRangeUser(0.001,200);
   mg->SetMinimum(0.000000000001);
   mg->SetMaximum(1000.);
   gPad->Modified();
TCanvas* c2 = new TCanvas("c2","ratioplot",800,600);
gStyle->SetOptStat(0);
    gStyle->SetLegendBorderSize(0);
ratio_plot->Draw("AP");
ratio_plot->GetXaxis()->SetLimits(0.1,20.);
ratio_plot->SetMinimum(0.);
   ratio_plot->SetMaximum(2.);
gPad->Modified();
