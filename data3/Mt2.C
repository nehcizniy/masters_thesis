...
filename_array[file_index]=filename;
    ...
    int k = file_index;
    for (int i = NumCentIndex-1; i < NumCentIndex; ++i) 
    {
...
// TCanvas* c4 = new TCanvas("c4","parameter0 vs #frac{dN_{ch}}{d#eta}",800,600);;
// //auto ratio_mass_parameters1 = new TGraphErrors(file_index, particle_mass3, parameter1, 0, error_parameter1);
...
// ratio_mass_parameters2->GetXaxis()->SetLimits(0.01,1100.);
// //for(int i=0;i<file_index;i++)
// //{
//  //   ratio_mass_parameters1->Add(p1[i]);
// //}
